...
const Nx, Ny, Nz = 60, 220, 85;
@everywhere const p_ref, ϕ_ref = 14.7, 0.2                           ## ϕ_ref is unused, p_ref used for ρ
@everywhere const S_wc, S_or = 0.2, 0.2                              ## SPE10 Config
...
@everywhere const C_water, C_r, C_oil    = 3e-6, 1e-6, 1.4e-6        ## C_w, C_r given SPE10 Config, C_oil?
...
@everywhere const μ_water, μ_oil = 0.3, 3.0 # cp ### SPE10 Config gives water viscosity, also oil pvt table gives \approx 3
## 3d model
## Porosity proportional control (PI propotional)

const Lx, Ly, Lz = 1200, 2200, 170
